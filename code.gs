 ...
 * Arquivo: Code.gs
 *
 * A interface utiliza o Index original, preservando todas as regras,
 * funções e funcionalidades. O arquivo LayoutOverride contém apenas
...
function doGet() {
  ...
  const html = index.replace("</body>", layout + "</body>");
